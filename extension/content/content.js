...
(function() {
  ...
  var root_3 = /* @__PURE__ */ from_html(`<hr class="jp-divider"/>`);
  var root_4 = /* @__PURE__ */ from_html(`<span class="jp-reading"> </span>`);
  var root_5 = /* @__PURE__ */ from_html(`<span class="jp-pos"> </span>`);
  var root_7 = /* @__PURE__ */ from_html(`<div class="jp-gloss"><span class="jp-num"></span> </div>`);
  var root_2 = /* @__PURE__ */ from_html(`<!>   <div class="jp-entry"><div class="jp-header"><span class="jp-word"> </span> <!> <span class="jp-pos-group"></span></div> <div class="jp-senses"></div> <button class="jp-add-btn"><!></button></div>`, 1);
  var root_1 = /* @__PURE__ */ from_html(`<div class="jp-popup"></div>`);
  function Popup($$anchor, $$props) {
    push($$props, true);
    const $popupStore = () => store_get(popupStore, "$popupStore", $$stores);
    const [$$stores, $$cleanup] = setup_stores();
    let buttonStates = /* @__PURE__ */ state(proxy({}));
    let entriesKey = /* @__PURE__ */ user_derived(() => $popupStore().entries.map((e) => e.sequence).join(","));
    user_effect(() => {
      get(entriesKey);
      set(buttonStates, {}, true);
    });
    function headword(e) {
      var _a2, _b2;
      return ((_a2 = e.kanji_forms[0]) == null ? void 0 : _a2.text) ?? ((_b2 = e.reading_forms[0]) == null ? void 0 : _b2.text) ?? "";
    }
    function reading(e) {
      var _a2;
      return ((_a2 = e.reading_forms[0]) == null ? void 0 : _a2.text) ?? "";
    }
    function firstGloss(e) {
      var _a2, _b2;
      return ((_b2 = (_a2 = e.senses[0]) == null ? void 0 : _a2.glosses.find((g) => g.lang === "eng")) == null ? void 0 : _b2.text) ?? "";
    }
    function position(node, params) {
    ...
    async function addToSrs(word, rdg, meaning) {
    ...
    var node_1 = first_child(fragment);
    {
      var consequent_5 = ($$anchor2) => {
        var div = root_1();
        each(div, 7, () => $popupStore().entries.slice(0, 4), (entry) => entry.sequence, ($$anchor3, entry, i) => {
          const hw = /* @__PURE__ */ user_derived(() => headword(get(entry)));
          const rdg = /* @__PURE__ */ user_derived(() => reading(get(entry)));
          const gloss = /* @__PURE__ */ user_derived(() => firstGloss(get(entry)));
          const btnState = /* @__PURE__ */ user_derived(() => get(buttonStates)[get(hw)] ?? "idle");
          ...
          var node_3 = sibling(span, 2);
          {
            var consequent_1 = ($$anchor4) => {
              ...
              template_effect(() => set_text(text_1, `【${get(rdg) ?? ""}】`));
              append($$anchor4, span_1);
            };
            if_block(node_3, ($$render) => {
              if (get(rdg) && get(rdg) !== get(hw)) $$render(consequent_1);
            });
          }
          var span_2 = sibling(node_3, 2);
          each(span_2, 21, () => {
            var _a2;
            return ((_a2 = get(entry).senses[0]) == null ? void 0 : _a2.pos) ?? [];
          }, index, ($$anchor4, pos) => {
            var span_3 = root_5();
          ...
          each(div_3, 21, () => get(entry).senses.slice(0, 3), index, ($$anchor4, sense, si) => {
            const g = /* @__PURE__ */ user_derived(() => get(sense).glosses.filter((g2) => g2.lang === "eng").map((g2) => g2.text).join("; "));
            ...
            var node_4 = first_child(fragment_2);
            {
              var consequent_2 = ($$anchor5) => {
                ...
                span_4.textContent = `${si + 1}.`;
                var text_3 = sibling(span_4, 1, true);
                template_effect(() => set_text(text_3, get(g)));
                append($$anchor5, div_4);
              };
              if_block(node_4, ($$render) => {
                if (get(g)) $$render(consequent_2);
              });
            }
          ...
          var node_5 = child(button);
          {
            var consequent_3 = ($$anchor4) => {
              var text_4 = text("+ Add to SRS");
              append($$anchor4, text_4);
            };
            var consequent_4 = ($$anchor4) => {
              var text_5 = text("Added!");
              append($$anchor4, text_5);
            };
            var alternate = ($$anchor4) => {
              var text_6 = text("Already added");
              append($$anchor4, text_6);
            };
            if_block(node_5, ($$render) => {
              if (get(btnState) === "idle") $$render(consequent_3);
              else if (get(btnState) === "added") $$render(consequent_4, 1);
              else $$render(alternate, -1);
            });
          }
          template_effect(() => {
            set_text(text$1, get(hw));
            button.disabled = get(btnState) !== "idle";
          });
          delegated("click", button, () => get(btnState) === "idle" && addToSrs(get(hw), get(rdg), get(gloss)));
          append($$anchor3, fragment_1);
        });
        action(div, ($$node, $$action_arg) => position == null ? void 0 : position($$node, $$action_arg), () => ({ x: $popupStore().x, y: $popupStore().y }));
        append($$anchor2, div);
      };
      if_block(node_1, ($$render) => {
        if ($popupStore().visible && $popupStore().entries.length > 0) $$render(consequent_5);
      });
    }
  ...
  delegate(["click"]);
  function getJapaneseAtPoint(x, y) {
  ...
  function setHighlight(node, charOffset, matchLen) {
...
`;
  ...
  popupStore.subscribe((state2) => {
    shadowHost.style.pointerEvents = state2.visible ? "auto" : "none";
  });
  initHighlight();
  function jsExtractRun(text2, charOffset) {
    const chars = [...text2];
  ...
  function isJpChar(ch) {
    ...
    return cp >= 19968 && cp <= 40959 || cp >= 13312 && cp <= 19903 || cp >= 12353 && cp <= 12447 || cp >= 12448 && cp <= 12543 || cp === 12540;
  }
  function extractRunAt(text2, charOffset) {
    return wasmExtractRun ? wasmExtractRun(text2, charOffset) : jsExtractRun(text2, charOffset);
  }
  ...
  async function handleHover(e) {
    ...
    const text2 = extractRunAt(hit.nodeText, hit.charOffset);
    if (!text2) {
      scheduleHide();
      return;
    }
    clearTimeout(hideTimer);
    try {
      const result = dictionary.lookup_at(text2);
      if (!((_a2 = result == null ? void 0 : result.entries) == null ? void 0 : _a2.length)) {
        scheduleHide();
        return;
      }
      const hw = ((_c = (_b2 = result.entries[0].kanji_forms) == null ? void 0 : _b2[0]) == null ? void 0 : _c.text) ?? ((_e = (_d = result.entries[0].reading_forms) == null ? void 0 : _d[0]) == null ? void 0 : _e.text) ?? text2;
      if (hw === lastLookedUp) return;
      lastLookedUp = hw;
      setHighlight(hit.node, hit.charOffset, result.match_len ?? 0);
      popupStore.show(result.entries, e.clientX, e.clientY);
      browser.runtime.sendMessage({ type: "LOG_LOOKUP", payload: { word: hw, reading: ((_g = (_f = result.entries[0].reading_forms) == null ? void 0 : _f[0]) == null ? void 0 : _g.text) ?? "" } });
    } catch (err) {
  ...
  document.addEventListener("mouseup", async (e) => {
    ...
    if (!text2 || text2.length > 50 || ![...text2].some((c) => isJpChar(c))) return;
    try {
      const entries = dictionary.lookup(text2);
      if (entries == null ? void 0 : entries.length) {
        popupStore.show(entries, e.clientX, e.clientY);
        lastLookedUp = text2;
      }
    } catch (err) {
