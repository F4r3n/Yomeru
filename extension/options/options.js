...
var root_3 = /* @__PURE__ */ from_html(`<p class="next-due svelte-11xnrmq"> </p>`);
var root_2 = /* @__PURE__ */ from_html(`<div class="review-done svelte-11xnrmq"><p>No cards due right now.</p> <!></div>`);
var root_5 = /* @__PURE__ */ from_html(`<div class="card-back"><div class="card-reading svelte-11xnrmq"> </div> <div class="card-meaning svelte-11xnrmq"> </div></div>`);
var root_6 = /* @__PURE__ */ from_html(`<button class="btn-show svelte-11xnrmq">Show answer</button>`);
var root_7 = /* @__PURE__ */ from_html(`<div class="rating-buttons svelte-11xnrmq"><button class="rating-btn r1 svelte-11xnrmq">Again</button> <button class="rating-btn r3 svelte-11xnrmq">Hard</button> <button class="rating-btn r4 svelte-11xnrmq">Good</button> <button class="rating-btn r5 svelte-11xnrmq">Easy</button></div>`);
var root_4 = /* @__PURE__ */ from_html(`<div class="card svelte-11xnrmq"><div class="card-front"><div class="card-word svelte-11xnrmq"> </div></div> <!> <div class="card-actions svelte-11xnrmq"><!></div></div>`);
var root_1 = /* @__PURE__ */ from_html(`<div class="review-stats svelte-11xnrmq"> </div> <!>`, 1);
var root_9 = /* @__PURE__ */ from_html(`<tr class="svelte-11xnrmq"><td class="td-word svelte-11xnrmq"> </td><td class="td-reading svelte-11xnrmq"> </td><td class="td-meaning svelte-11xnrmq"> </td><td> </td><td class="svelte-11xnrmq"><button class="btn-delete svelte-11xnrmq">Delete</button></td></tr>`);
var root_8 = /* @__PURE__ */ from_html(`<div class="word-list-header svelte-11xnrmq"><span class="word-count svelte-11xnrmq"> </span> <input class="word-search svelte-11xnrmq" type="search" placeholder="Search…"/></div> <table class="word-table svelte-11xnrmq"><thead><tr><th class="svelte-11xnrmq">Word</th><th class="svelte-11xnrmq">Reading</th><th class="svelte-11xnrmq">Meaning</th><th class="svelte-11xnrmq">Due</th><th class="svelte-11xnrmq"></th></tr></thead><tbody></tbody></table>`, 1);
var root = /* @__PURE__ */ from_html(`<header class="svelte-11xnrmq"><h1 class="svelte-11xnrmq">Japanese Reader</h1> <nav class="svelte-11xnrmq"><button>Review</button> <button>Word List</button></nav></header> <main class="svelte-11xnrmq"><!></main>`, 1);
const $$css = {
  hash: "svelte-11xnrmq",
  code: ':root {--bg: #1e1e2e;--surface: #313244;--border: #45475a;--text: #cdd6f4;--subtext: #a6adc8;--accent: #cba6f7;--green: #a6e3a1;--red: #f38ba8;--yellow: #f9e2af;--blue: #89dceb;}* {box-sizing:border-box;margin:0;padding:0;}body {background:var(--bg);color:var(--text);font-family:"Noto Sans JP", "Segoe UI", sans-serif;font-size:14px;min-width:440px;min-height:300px;padding:0 0 16px;}header.svelte-11xnrmq {background:var(--surface);padding:12px 16px 0;border-bottom:1px solid var(--border);}h1.svelte-11xnrmq {font-size:16px;font-weight:700;color:var(--blue);margin-bottom:10px;}nav.svelte-11xnrmq {display:flex;gap:4px;}.tab.svelte-11xnrmq {background:none;border:none;border-bottom:2px solid transparent;color:var(--subtext);cursor:pointer;padding:6px 12px;font-size:13px;transition:color 0.15s, border-color 0.15s;}.tab.active.svelte-11xnrmq {color:var(--accent);border-bottom-color:var(--accent);}.tab.svelte-11xnrmq:hover  {color:var(--text);}main.svelte-11xnrmq {padding:16px;}.review-stats.svelte-11xnrmq {font-size:13px;color:var(--subtext);margin-bottom:12px;}.card.svelte-11xnrmq {background:var(--surface);border:1px solid var(--border);border-radius:10px;padding:24px 20px 16px;text-align:center;}.card-word.svelte-11xnrmq    {font-size:42px;font-weight:700;color:var(--blue);margin-bottom:8px;}.card-reading.svelte-11xnrmq {font-size:18px;color:var(--green);margin-bottom:6px;}.card-meaning.svelte-11xnrmq {font-size:16px;color:var(--text);margin-bottom:4px;}.card-actions.svelte-11xnrmq {margin-top:20px;}.btn-show.svelte-11xnrmq {background:var(--accent);border:none;border-radius:6px;color:var(--bg);cursor:pointer;font-size:14px;font-weight:600;padding:8px 32px;transition:opacity 0.15s;}.btn-show.svelte-11xnrmq:hover {opacity:0.85;}.rating-buttons.svelte-11xnrmq {display:flex;gap:8px;justify-content:center;}.rating-btn.svelte-11xnrmq {border:none;border-radius:6px;cursor:pointer;font-size:13px;font-weight:600;padding:7px 16px;transition:opacity 0.15s;}.rating-btn.svelte-11xnrmq:hover {opacity:0.85;}.r1.svelte-11xnrmq {background:var(--red);color:var(--bg);}.r3.svelte-11xnrmq {background:var(--yellow);color:var(--bg);}.r4.svelte-11xnrmq {background:var(--green);color:var(--bg);}.r5.svelte-11xnrmq {background:var(--blue);color:var(--bg);}.review-done.svelte-11xnrmq {text-align:center;padding:32px;color:var(--subtext);}.next-due.svelte-11xnrmq {margin-top:8px;color:var(--accent);}.word-list-header.svelte-11xnrmq {display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;}.word-count.svelte-11xnrmq {color:var(--subtext);font-size:13px;}.word-search.svelte-11xnrmq {background:var(--surface);border:1px solid var(--border);border-radius:6px;color:var(--text);font-size:13px;padding:4px 10px;outline:none;width:180px;}.word-search.svelte-11xnrmq:focus {border-color:var(--accent);}.word-table.svelte-11xnrmq {width:100%;border-collapse:collapse;font-size:13px;}.word-table.svelte-11xnrmq th:where(.svelte-11xnrmq) {text-align:left;padding:6px 8px;border-bottom:1px solid var(--border);color:var(--subtext);font-weight:500;}.word-table.svelte-11xnrmq td:where(.svelte-11xnrmq) {padding:6px 8px;border-bottom:1px solid var(--border);vertical-align:top;}.word-table.svelte-11xnrmq tr:where(.svelte-11xnrmq):last-child td:where(.svelte-11xnrmq) {border-bottom:none;}.td-word.svelte-11xnrmq    {font-size:18px;color:var(--blue);}.td-reading.svelte-11xnrmq {color:var(--green);}.td-meaning.svelte-11xnrmq {color:var(--text);max-width:180px;}.td-due.overdue.svelte-11xnrmq {color:var(--red);}.td-due.today.svelte-11xnrmq   {color:var(--yellow);}.td-due.future.svelte-11xnrmq  {color:var(--subtext);}.btn-delete.svelte-11xnrmq {background:none;border:1px solid var(--border);border-radius:4px;color:var(--red);cursor:pointer;font-size:11px;padding:2px 8px;}.btn-delete.svelte-11xnrmq:hover {background:var(--surface);}'
};
function Options($$anchor, $$props) {
  push($$props, true);
  append_styles($$anchor, $$css);
  let tab = /* @__PURE__ */ state("review");
  let dueCards = /* @__PURE__ */ state(proxy([]));
  let currentIdx = /* @__PURE__ */ state(0);
  let showBack = /* @__PURE__ */ state(false);
  let nextDueMsg = /* @__PURE__ */ state("");
  let currentCard = /* @__PURE__ */ user_derived(() => get(dueCards)[get(currentIdx)] ?? null);
  let reviewDone = /* @__PURE__ */ user_derived(() => !get(currentCard));
  let statsText = /* @__PURE__ */ user_derived(() => `${get(dueCards).length} card${get(dueCards).length !== 1 ? "s" : ""} due`);
  let allCards = /* @__PURE__ */ state(proxy([]));
  let searchQuery = /* @__PURE__ */ state("");
  let filteredCards = /* @__PURE__ */ user_derived(() => get(allCards).filter((c) => {
    if (!get(searchQuery)) return true;
    const q = get(searchQuery).toLowerCase();
    return c.word.includes(q) || c.reading.includes(q) || c.meaning_en.toLowerCase().includes(q);
  }).sort((a, b) => a.due_ms - b.due_ms));
  user_effect(() => {
    if (get(tab) === "review") loadReview();
    else loadWords();
  });
  async function loadReview() {
    const res = await browser.runtime.sendMessage({ type: "GET_DUE" });
    set(dueCards, res.cards ?? [], true);
    set(currentIdx, 0);
    set(showBack, false);
    set(nextDueMsg, "");
  }
  async function loadWords() {
    ...
    set(allCards, res.cards ?? [], true);
  }
  async function rate(rating) {
    if (!get(currentCard)) return;
    await browser.runtime.sendMessage({
      type: "REVIEW_CARD",
      payload: { word: get(currentCard).word, rating }
    });
    update(currentIdx);
    set(showBack, false);
    if (get(reviewDone)) await computeNextDue();
  }
  async function computeNextDue() {
    const res = await browser.runtime.sendMessage({ type: "GET_ALL_CARDS" });
    const cards = res.cards ?? [];
    const now = Date.now();
    const next = cards.reduce((m, c) => c.due_ms > now && c.due_ms < m ? c.due_ms : m, Infinity);
    if (next < Infinity) {
      const mins = Math.round((next - now) / 6e4);
      set(
        nextDueMsg,
        mins < 60 ? `Next card due in ${mins} min` : `Next card due in ${Math.round(mins / 60)} hr`,
        true
      );
    }
  }
  async function deleteCard(word) {
    ...
    set(allCards, get(allCards).filter((c) => c.word !== word), true);
  }
  function dueLabel(ms) {
    const diff = ms - Date.now();
    if (diff <= 0) return "Due now";
    const h = Math.round(diff / 36e5);
    return h < 24 ? `${h}h` : `${Math.round(diff / 864e5)}d`;
  }
  ...
  var node = child(main);
  {
        ...
        var consequent_1 = ($$anchor3) => {
          ...
          var node_2 = sibling(child(div_1), 2);
          {
            var consequent = ($$anchor4) => {
              var p = root_3();
              var text_1 = child(p);
              template_effect(() => set_text(text_1, get(nextDueMsg)));
              append($$anchor4, p);
            };
            if_block(node_2, ($$render) => {
              if (get(nextDueMsg)) $$render(consequent);
            });
          }
        ...
        var alternate_1 = ($$anchor3) => {
          ...
          var node_3 = sibling(div_3, 2);
          {
            var consequent_2 = ($$anchor4) => {
              ...
              template_effect(() => {
                var _a2, _b2;
                set_text(text_3, (_a2 = get(currentCard)) == null ? void 0 : _a2.reading);
                set_text(text_4, (_b2 = get(currentCard)) == null ? void 0 : _b2.meaning_en);
              });
              append($$anchor4, div_5);
            };
            if_block(node_3, ($$render) => {
              if (get(showBack)) $$render(consequent_2);
            });
          }
          ...
          var node_4 = child(div_8);
          {
            var consequent_3 = ($$anchor4) => {
              var button_2 = root_6();
              delegated("click", button_2, () => set(showBack, true));
            ...
            var alternate = ($$anchor4) => {
              ...
              delegated("click", button_3, () => rate(1));
              delegated("click", button_4, () => rate(3));
              delegated("click", button_5, () => rate(4));
              delegated("click", button_6, () => rate(5));
              append($$anchor4, div_9);
            };
            if_block(node_4, ($$render) => {
              if (!get(showBack)) $$render(consequent_3);
              else $$render(alternate, -1);
            });
          }
          template_effect(() => {
            var _a2;
            return set_text(text_2, (_a2 = get(currentCard)) == null ? void 0 : _a2.word);
          });
          append($$anchor3, div_2);
        };
        if_block(node_1, ($$render) => {
          if (get(reviewDone)) $$render(consequent_1);
          else $$render(alternate_1, -1);
        });
      }
      template_effect(() => set_text(text, get(statsText)));
    ...
    var alternate_2 = ($$anchor2) => {
      ...
      each(tbody, 21, () => get(filteredCards), (card) => card.word, ($$anchor3, card) => {
        var tr = root_9();
        var td = child(tr);
        var text_6 = child(td);
        var td_1 = sibling(td);
        ...
        var button_7 = child(td_4);
        template_effect(
          ($0, $1) => {
            set_text(text_6, get(card).word);
            set_text(text_7, get(card).reading);
            set_text(text_8, get(card).meaning_en);
            set_class(td_3, 1, `td-due ${$0 ?? ""}`, "svelte-11xnrmq");
            set_text(text_9, $1);
          },
          [
            () => dueClass(get(card).due_ms),
            () => dueLabel(get(card).due_ms)
          ]
        );
        delegated("click", button_7, () => deleteCard(get(card).word));
        append($$anchor3, tr);
      });
      template_effect(() => set_text(text_5, `${get(filteredCards).length ?? ""} words`));
      bind_value(input, () => get(searchQuery), ($$value) => set(searchQuery, $$value));
      append($$anchor2, fragment_2);
    };
    if_block(node, ($$render) => {
      if (get(tab) === "review") $$render(consequent_4);
      else $$render(alternate_2, -1);
    });
  }
  template_effect(() => {
    classes = set_class(button, 1, "tab svelte-11xnrmq", null, classes, { active: get(tab) === "review" });
    classes_1 = set_class(button_1, 1, "tab svelte-11xnrmq", null, classes_1, { active: get(tab) === "words" });
  });
  delegated("click", button, () => set(tab, "review"));
  delegated("click", button_1, () => set(tab, "words"));
